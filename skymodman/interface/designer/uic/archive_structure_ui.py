...
class Ui_mod_structure_dialog(object):
    def setupUi(self, mod_structure_dialog):
        ...
        self.gridLayout.addWidget(self.fsview, 0, 1, 10, 3)
        ...
        self.gridLayout.addWidget(self._buttonbox, 8, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout.addWidget(self.change_view_btngroup, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.undo_btngroup, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.view_switcher, 0, 4, 10, 1)
        ...
        self._structure_label_layout = QtWidgets.QHBoxLayout()
        self._structure_label_layout.setObjectName("_structure_label_layout")
        self.lbl_structure_status = QtWidgets.QLabel(mod_structure_dialog)
        self.lbl_structure_status.setObjectName("lbl_structure_status")
        self._structure_label_layout.addWidget(self.lbl_structure_status)
        self.lbl_structure_icon = QtWidgets.QLabel(mod_structure_dialog)
        self.lbl_structure_icon.setObjectName("lbl_structure_icon")
        self._structure_label_layout.addWidget(self.lbl_structure_icon)
        self.gridLayout.addLayout(self._structure_label_layout, 3, 0, 1, 1)
    ...
    def retranslateUi(self, mod_structure_dialog):
        ...
        self.lbl_structure_status.setText(_translate("mod_structure_dialog", "Structure:"))
        self.lbl_structure_icon.setText(_translate("mod_structure_dialog", "OK"))
