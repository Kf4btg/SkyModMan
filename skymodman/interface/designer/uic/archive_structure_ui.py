...
class Ui_mod_structure_dialog(object):
    def setupUi(self, mod_structure_dialog):
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 55, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 1, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 55, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem1, 3, 0, 1, 1)
        self.mod_structure_view = QtWidgets.QTreeWidget(mod_structure_dialog)
        ...
        self._buttonbox.setCenterButtons(False)
