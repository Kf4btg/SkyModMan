...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.installed_mods_tab)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.new_profile_button = QtWidgets.QToolButton(self.installed_mods_tab)
        ...
        self.gridLayout_2.addWidget(self.new_profile_button, 0, 2, 1, 1)
        self.profile_label = QtWidgets.QLabel(self.installed_mods_tab)
        self.profile_label.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        self.profile_label.setObjectName("profile_label")
        self.gridLayout_2.addWidget(self.profile_label, 0, 0, 1, 1, QtCore.Qt.AlignLeft)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem, 0, 4, 1, 1)
        self.remove_profile_button = QtWidgets.QToolButton(self.installed_mods_tab)
        ...
        self.gridLayout_2.addWidget(self.remove_profile_button, 0, 3, 1, 1)
        self.profile_selector = QtWidgets.QComboBox(self.installed_mods_tab)
        self.profile_selector.setObjectName("profile_selector")
        self.profile_selector.addItem("")
        self.profile_selector.addItem("")
        self.gridLayout_2.addWidget(self.profile_selector, 0, 1, 1, 1)
        self.mod_table = QtWidgets.QTableWidget(self.installed_mods_tab)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.mod_table.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(0, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(0, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(0, 3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsDropEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Checked)
        self.mod_table.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(1, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(1, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(1, 3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsDropEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Checked)
        self.mod_table.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(2, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(2, 2, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(2, 3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setFlags(QtCore.Qt.ItemIsSelectable|QtCore.Qt.ItemIsDragEnabled|QtCore.Qt.ItemIsDropEnabled|QtCore.Qt.ItemIsUserCheckable|QtCore.Qt.ItemIsEnabled)
        item.setCheckState(QtCore.Qt.Checked)
        self.mod_table.setItem(3, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(3, 1, item)
        item = QtWidgets.QTableWidgetItem()
        self.mod_table.setItem(3, 2, item)
        item = QtWidgets.QTableWidgetItem()
        ...
        self.menuProfile.addAction(self.actionCopy)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.mod_table.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Name"))
        __sortingEnabled = self.mod_table.isSortingEnabled()
        self.mod_table.setSortingEnabled(False)
        item = self.mod_table.item(0, 1)
        item.setText(_translate("MainWindow", "5878"))
        item = self.mod_table.item(0, 2)
        item.setText(_translate("MainWindow", "d5464"))
        item = self.mod_table.item(0, 3)
        item.setText(_translate("MainWindow", "Test Mod 1"))
        item = self.mod_table.item(1, 1)
        item.setText(_translate("MainWindow", "46840"))
        item = self.mod_table.item(1, 2)
        item.setText(_translate("MainWindow", "v1.0"))
        item = self.mod_table.item(1, 3)
        item.setText(_translate("MainWindow", "Cool Mod 2"))
        item = self.mod_table.item(2, 1)
        item.setText(_translate("MainWindow", "0"))
        item = self.mod_table.item(2, 2)
        item.setText(_translate("MainWindow", "big bertha"))
        item = self.mod_table.item(2, 3)
        item.setText(_translate("MainWindow", "Crappy Mod 0"))
        item = self.mod_table.item(3, 1)
        item.setText(_translate("MainWindow", "0"))
        item = self.mod_table.item(3, 2)
        item.setText(_translate("MainWindow", "0.0.1"))
        item = self.mod_table.item(3, 3)
        item.setText(_translate("MainWindow", "Supercalifragilisticexpialidocious"))
        self.mod_table.setSortingEnabled(__sortingEnabled)
