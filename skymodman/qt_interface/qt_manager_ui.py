...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.installed_mods_layout.addWidget(self.filters_dropdown, 0, 4, 1, 1)
        ...
        self.installed_mods_layout.addItem(spacerItem1, 0, 3, 1, 1)
        ...
        self.edit_toolBar = QtWidgets.QToolBar(MainWindow)
        self.edit_toolBar.setObjectName("edit_toolBar")
        MainWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.edit_toolBar)
        ...
        self.action_togglemod = QtWidgets.QAction(MainWindow)
        self.action_togglemod.setEnabled(False)
        self.action_togglemod.setObjectName("action_togglemod")
        ...
        self.actionMove_Mod_Up = QtWidgets.QAction(MainWindow)
        self.actionMove_Mod_Up.setEnabled(False)
        icon = QtGui.QIcon.fromTheme("arrow-up")
        self.actionMove_Mod_Up.setIcon(icon)
        self.actionMove_Mod_Up.setObjectName("actionMove_Mod_Up")
        self.actionMove_Mod_Down = QtWidgets.QAction(MainWindow)
        self.actionMove_Mod_Down.setEnabled(False)
        icon = QtGui.QIcon.fromTheme("arrow-down")
        self.actionMove_Mod_Down.setIcon(icon)
        self.actionMove_Mod_Down.setObjectName("actionMove_Mod_Down")
        self.actionMove_Mod_To_Top = QtWidgets.QAction(MainWindow)
        self.actionMove_Mod_To_Top.setEnabled(False)
        icon = QtGui.QIcon.fromTheme("go-top")
        self.actionMove_Mod_To_Top.setIcon(icon)
        self.actionMove_Mod_To_Top.setObjectName("actionMove_Mod_To_Top")
        self.actionMove_Mod_To_Bottom = QtWidgets.QAction(MainWindow)
        self.actionMove_Mod_To_Bottom.setEnabled(False)
        icon = QtGui.QIcon.fromTheme("go-bottom")
        self.actionMove_Mod_To_Bottom.setIcon(icon)
        self.actionMove_Mod_To_Bottom.setObjectName("actionMove_Mod_To_Bottom")
        self.menu_File.addAction(self.action_Install_Fomod)
        self.menu_File.addAction(self.actionChoose_Mod_Folder)
        self.menu_File.addSeparator()
        self.menu_File.addAction(self.actionSave_Changes)
        ...
        self.menuEdit.addAction(self.action_togglemod)
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionMove_Mod_Up)
        self.menuEdit.addAction(self.actionMove_Mod_Down)
        self.menuEdit.addAction(self.actionMove_Mod_To_Top)
        self.menuEdit.addAction(self.actionMove_Mod_To_Bottom)
        self.menubar.addAction(self.menu_File.menuAction())
        self.menubar.addAction(self.menuEdit.menuAction())
        self.menubar.addAction(self.menuProfile.menuAction())
        self.file_toolBar.addAction(self.actionChoose_Mod_Folder)
        self.file_toolBar.addAction(self.action_Install_Fomod)
        self.edit_toolBar.addAction(self.actionMove_Mod_To_Top)
        self.edit_toolBar.addAction(self.actionMove_Mod_Up)
        self.edit_toolBar.addAction(self.actionMove_Mod_Down)
        self.edit_toolBar.addAction(self.actionMove_Mod_To_Bottom)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_toolBar.setWindowTitle(_translate("MainWindow", "toolBar"))
        ...
        self.action_togglemod.setText(_translate("MainWindow", "Toggle &Selection Active"))
        self.action_togglemod.setToolTip(_translate("MainWindow", "Enable or Disable Selected Mod(s)"))
        self.action_togglemod.setShortcut(_translate("MainWindow", "Space"))
        self.actionSave_Changes.setText(_translate("MainWindow", "&Save Changes"))
        self.actionMove_Mod_Up.setText(_translate("MainWindow", "Move Mod Up"))
        self.actionMove_Mod_Up.setToolTip(_translate("MainWindow", "Move mod earlier in the install sequence"))
        self.actionMove_Mod_Up.setShortcut(_translate("MainWindow", "Ctrl+Up"))
        self.actionMove_Mod_Down.setText(_translate("MainWindow", "Move Mod Down"))
        self.actionMove_Mod_Down.setToolTip(_translate("MainWindow", "Move mod later in the install sequence"))
        self.actionMove_Mod_Down.setShortcut(_translate("MainWindow", "Ctrl+Down"))
        self.actionMove_Mod_To_Top.setText(_translate("MainWindow", "Move Mod To Top"))
        self.actionMove_Mod_To_Top.setToolTip(_translate("MainWindow", "Move mod to the start of the install sequence"))
        self.actionMove_Mod_To_Top.setShortcut(_translate("MainWindow", "Ctrl+Shift+Up"))
        self.actionMove_Mod_To_Bottom.setText(_translate("MainWindow", "Move Mod To Bottom"))
        self.actionMove_Mod_To_Bottom.setToolTip(_translate("MainWindow", "Move mod to the end of the install sequence"))
        self.actionMove_Mod_To_Bottom.setShortcut(_translate("MainWindow", "Ctrl+Shift+Down"))
