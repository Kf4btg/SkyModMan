...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_moddown = QtWidgets.QToolButton(self.move_mod_box)
        icon = QtGui.QIcon.fromTheme("arrow-down")
        self.btn_moddown.setIcon(icon)
        self.btn_moddown.setObjectName("btn_moddown")
        self.gridLayout_2.addWidget(self.btn_moddown, 0, 3, 1, 1)
        self.btn_modup = QtWidgets.QToolButton(self.move_mod_box)
        icon = QtGui.QIcon.fromTheme("arrow-up")
        self.btn_modup.setIcon(icon)
        self.btn_modup.setObjectName("btn_modup")
        self.gridLayout_2.addWidget(self.btn_modup, 0, 2, 1, 1)
        ...
        self.btn_modtotop = QtWidgets.QToolButton(self.move_mod_box)
        icon = QtGui.QIcon.fromTheme("go-top")
        self.btn_modtotop.setIcon(icon)
        self.btn_modtotop.setObjectName("btn_modtotop")
        self.gridLayout_2.addWidget(self.btn_modtotop, 0, 1, 1, 1)
        self.btn_modtobottom = QtWidgets.QToolButton(self.move_mod_box)
        icon = QtGui.QIcon.fromTheme("go-bottom")
        self.btn_modtobottom.setIcon(icon)
        self.btn_modtobottom.setObjectName("btn_modtobottom")
        self.gridLayout_2.addWidget(self.btn_modtobottom, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_moddown.setStatusTip(_translate("MainWindow", "Move selected mod(s) down in the install order."))
        self.btn_modup.setStatusTip(_translate("MainWindow", "Move selected mod(s) up in the install order."))
        ...
        self.action_togglemod.setText(_translate("MainWindow", "Toggle &Enabled"))
